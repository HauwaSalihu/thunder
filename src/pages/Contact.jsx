...
<p  className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'> 
    Get in Touch
    Sign up for early access to our savings and investment features, or get in touch to partner with us.
</p>
...
<form  className='max-w-2xl mx-auto' onSubmit={onSubmit} >
    <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
        ...
        <input  type="email" name='email' placeholder='Enter your Email' className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90'  required/>
    </div>
...
<button  type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit now </button>
