  ...
  return (
    <div className='mb-60 p-3 flex flex-col items-center justify-center mt-20'>
      <h1 className='text-center text-4xl md:text-5xl font-extrabold text-gray-900 leading-snug max-w-4xl'>
        Digitizing <span className='text-orange-600 '>Nigeria’s Traditional Savings Culture</span>
      </h1>
      ...
      <div className='mt-8 flex gap-4'>
        <NavLink to={"https://forms.gle/JnSNWv9WQdM8Fzbn6"} target='_blank'>
          <button className='bg-orange-500  text-white py-3 px-6 rounded-full text-sm lg:text-lg font-medium hover:bg-orange-700 transition'>
            Join the Waitlist
          </button>
        </NavLink>
        <NavLink to={"/thunder-contact"}>
          <button className='border border-orange-500  text-orange-600  py-3 px-6 rounded-full text-sm lg:text-lg font-medium hover:bg-orange-100 transition'>
            Partner With Us
          </button>
        </NavLink>
      </div>
