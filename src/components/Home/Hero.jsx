...
function Hero() {
  return (
    <div className='bg-gradient-to-br p-30 from-blue-200 to-blue-900'>

    <section className="text-white text-center container mx-auto py-24 px-4">
    <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">Tailored IT Solutions<br />for Your Business</h1>
    <p className="text-lg max-w-xl mx-auto mb-8">Expert web and app design services to elevate your brand.</p>
    <button className="px-6 py-2 border-2 border-white rounded-full hover:bg-white hover:text-blue-900 transition">Get Started</button>

    {/* Service Cards */}
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-16 px-4">
    <div className="bg-white/10 p-6 rounded text-white backdrop-blur-sm">
